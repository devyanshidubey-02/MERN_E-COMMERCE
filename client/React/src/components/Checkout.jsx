...
const Checkout = () => {
  ...
  const handlePayment = async () => {
    try {
      ...
      var options = {
        key: "rzp_test_9FfrpHPIMc3fTL", // Enter the Key ID generated from the Dashboard
        amount: orderAmount * 100, // Amount is in currency subunits. Default currency is INR. Hence, 50000 refers to 50000 paise
        currency: "INR",
        name: "E-COMMERCE",
        description: "E-COMMERCE WITH PAYMENT GATEWAY",
        ...
        prefill: {
          name: "E-COMMERCE",
          email: "ritikadu20@gmail.com",
          contact: "9000090000",
        },
        notes: {
          address: "Vijay Nagar Bhopal",
        },
        theme: {
          color: "#3399cc",
        },
